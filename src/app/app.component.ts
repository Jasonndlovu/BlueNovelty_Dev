...
export class AppComponent {
  public appPages = [
    ...
    { title: 'Offers', url: '/folder/offers' },
    { title: 'Alerts', url: '/folder/outbox'},
    { title: 'Messages', url: '/folder/messages'},
    { title: 'Service History', url: '/folder/service'},
    { title: 'Switch Accounts????', url: '/folder/switch'},
    { title: 'Log out', url: '/folder/spam'},
  ];
